...
type handleProcessType = 'video-end' | 'video-last' | 'video-reset' | 'pause' | 'play' | string
...
const VideoCarousel = () => {
  ...
  const handleLoadedMetaData = (e: SyntheticEvent<HTMLVideoElement, Event>) => setLoadedData((pre) => [...pre, e])
